...
straight(-172)
LAM.run_time(-1500, 1000, Stop.NONE) #make the drop the arm 
LAM.run_time(1500, 1000, Stop.NONE) #make the arm go up
LAM.run_time(-1500, 1000, Stop.NONE) #make the arm go down
LAM.run_time(1500, 1000, Stop.NONE) #make the arm go up
LAM.run_time(-1500, 1000, Stop.NONE) #make the drop the arm 
LAM.run_time(1500, 1000, Stop.NONE) #make the arm go up
LAM.run_time(-1500, 1000, Stop.NONE) #make the arm go down
